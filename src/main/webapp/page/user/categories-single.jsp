                        ...
                        <div class="row pt-5 ml-lg-5 mr-lg-5">
                            <div class="col-md-10 offset-1">
                                <div class="row my-5 pt-5">
                                    <div class="col-md-3">
                                        <img src="${pageContext.request.contextPath}/page/user/assets/img/demo/a1.jpg" alt="/">
                                    </div>
                                    <div class="col-md-9">
                                        <div class="d-md-flex align-items-center justify-content-between">
                                            <h1 class="my-3 text-white ">${sessionScope.type.name}</h1>
                                        ...
                                        <div class="text-white my-2">
                                            <p>歌曲数量：${sessionScope.type.songCount}</p>
                                                        ...
                                                        <c:if test="${sessionScope.songPage.list != null || sessionScope.songPage.list.size() != 0}">
                                                            ...
                                                            <c:forEach items="${sessionScope.songPage.list}" var="song" varStatus="s">
                                                                <li class="list-group-item my-1">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="col-1">
                                                                            <a class="no-ajaxy media-url" href="${pageContext.request.contextPath}/${song.url}" id="play_${song.songId}" data-wave="assets/media/track1.json">
...
<script type="text/javascript">
    ...
    function prev(){
        window.location.href = "${pageContext.request.contextPath}/getAllCategoriesSongServlet?songType=${sessionScope.type.name}&currentPage=${sessionScope.songPage.currentPage - 1}&rows=10"
    }
